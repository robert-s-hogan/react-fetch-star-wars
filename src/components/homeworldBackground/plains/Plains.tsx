...
const Plains: React.FC<Props> = (props) => {
  ...
  return (
    <div className="w-96 h-96 bg-plains">
      ...
      <div className="landscape-1 absolute bottom-24 md:bottom-28 lg:bottom-32 xl:bottom-48 h-16 -left-2 w-screen -rotate-8"></div>
      <div className="landscape-2  absolute bottom-22 md:bottom-12 xl:-bottom-8 h-16 -left-2.5 w-screen rotate-8"></div>
      <div className="landscape-3 absolute bottom-20 md:bottom-24 lg:bottom-28 xl:bottom-44 -left-2.5 h-16 w-screen -rotate-8"></div>
      <div className="landscape-4 absolute bottom-8 md:bottom-0 lg:bottom-4 xl:bottom-0 -left-2.5 h-24 xl:h-16 w-screen rotate-2"></div>
      <div className="landscape-5 absolute -bottom-6 md:-bottom-4 lg:bottom-6 xl:bottom-24 -left-2.5 h-24 xl:h-20 w-screen -rotate-8"></div>
